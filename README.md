...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fanstatic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8039&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fanstatic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fanstatic` can be installed with:

```
conda install fanstatic
```

It is possible to list all of the versions of `fanstatic` available on your platform with:
